...
from KTA2_in_python.util.util import cal_convergence
from KTA2_in_python.util.util import pure_diversity


def adaptive_sampling(cca_obj, cca_dec, cda_obj, cda_dec, davar, da, mu, p, phi):
    ...
    if flag:
        ...
        if pure_diversity(cda_obj) < pure_diversity(da_obj):
